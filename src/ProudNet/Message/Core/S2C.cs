...
namespace ProudNet.Message.Core
{
    ...
    internal class NotifyServerConnectionHintMessage : CoreMessage
    {
        ...
        public NotifyServerConnectionHintMessage(ProudConfig config, RSAParameters publicKey)
        {
            Config = config;
            PublicKey = publicKey;
        }
        ...
        internal class Serializer : ISerializer<NotifyServerConnectionHintMessage>
        {
            ...
            {
                var config = BlubLib.Serialization.Serializer.Deserialize<ProudConfig>(reader);
